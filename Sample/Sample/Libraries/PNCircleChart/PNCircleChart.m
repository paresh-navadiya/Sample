...
- (id)initWithFrame:(CGRect)frame total:(NSNumber *)total current:(NSNumber *)current clockwise:(BOOL)clockwise shadow:(BOOL)hasBackgroundShadow shadowColor:(UIColor *)backgroundShadowColor displayCountingLabel:(BOOL)displayCountingLabel {
    ...
    return [self initWithFrame:frame
                     ...
                     clockwise:clockwise
                        shadow:shadow
                   shadowColor:[UIColor colorWithRed:77.0 / 255.0 green:186.0 / 255.0 blue:122.0 / 255.0 alpha:1.0f]
  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        _total = total;
        _current = current;
        _strokeColor = [UIColor colorWithRed:77.0 / 255.0 green:186.0 / 255.0 blue:122.0 / 255.0 alpha:1.0f];
        _duration = 1.0;
        ...
        [_countingLabel setFont:[UIFont boldSystemFontOfSize:26.0f]];
